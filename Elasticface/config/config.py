...
config.lr = 0.1
config.output = "/media/statlab/SeagateHDD/Fateme Tavakoli/ElasticFace/output/ElasticFace-Arc" # train model output folder
...
if config.dataset == "emoreIresNet":
    config.rec = "/media/statlab/SeagateHDD/Fateme Tavakoli/ElasticFace/faces_emore"
